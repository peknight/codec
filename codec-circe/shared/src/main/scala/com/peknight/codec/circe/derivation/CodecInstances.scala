...
object CodecInstances extends ObjectTypeInstances with DecodeObjectOpsInstances
  ...
  def derived[A](using configuration: CodecConfiguration)(using
    ...
    CodecCodecInstances.derived[Id, Json, JsonObject, ACursor, DecodingFailure, A](using configuration).asCirceCodec
end CodecInstances
