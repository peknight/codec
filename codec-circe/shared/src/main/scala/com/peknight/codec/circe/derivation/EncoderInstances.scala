...
import com.peknight.codec.circe.instances.CodecObjectOpsInstances
...
object EncoderInstances extends EncoderInstances with CodecObjectOpsInstances with instances.EncoderInstances:
