...
trait PortInstances1:
  ...
  given decodePortN[F[_]: Applicative, S: NumberType]: Decoder[F, Cursor[S], Port] = Decoder.decodeN[F, S, Port]
  given stringCodecPort[F[_]: Applicative]: Codec[F, String, String, Port] = Codec.stringCodecWithNumberDecoder[F, Port]
  given codecPortS[F[_]: Applicative, S: StringType]: Codec[F, S, Cursor[S], Port] = Codec.codecS[F, S, Port]
end PortInstances1
