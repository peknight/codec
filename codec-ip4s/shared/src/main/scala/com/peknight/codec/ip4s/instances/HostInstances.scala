...
trait HostInstances:
  ...
  given codecHostnameS[F[_]: Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], Hostname] = 
    Codec.codecS[F, S, Hostname]
  ...
  given codecIDNS[F[_]: Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], IDN] = Codec.codecS[F, S, IDN]
  ...
  given codecIpv4AddressS[F[_]: Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], Ipv4Address] =
  ...
  given codecIpv6AddressS[F[_] : Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], Ipv6Address] =
  ...
  given codecIpAddressS[F[_] : Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], IpAddress] =
  ...
  given codecHostS[F[_] : Applicative, S: {StringType, Show}]: Codec[F, S, Cursor[S], Host] =
