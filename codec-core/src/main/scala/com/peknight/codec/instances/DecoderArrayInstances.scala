...
trait DecoderArrayInstances extends DecoderArrayInstances1:
  given decodeSetA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  : Decoder[F, Cursor[S], Set[A]] =
    Decoder.decodeSeq[F, S, A, Set](Set.newBuilder[A])

  given decodeListA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  : Decoder[F, Cursor[S], List[A]] =
    Decoder.decodeSeq[F, S, A, List](List.newBuilder[A])

  given decodeVectorA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  : Decoder[F, Cursor[S], Vector[A]] =
    Decoder.decodeSeq[F, S, A, Vector](Vector.newBuilder[A])

  given decodeChainA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  : Decoder[F, Cursor[S], Chain[A]] =
    Decoder.decodeSeq[F, S, A, Chain](new ChainBuilder[A])

  given decodeNonEmptyListA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  ...
  given decodeNonEmptyVectorA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
  ...
  given decodeSeqA[F[_], S, A](using Applicative[F], Decoder[F, Cursor[S], A], ArrayType[S], Show[S])
