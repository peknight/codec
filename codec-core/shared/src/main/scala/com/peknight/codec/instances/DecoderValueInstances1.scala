...
trait DecoderValueInstances1:
  ...
  given decodeBooleanB[F[_]: Applicative, S: {BooleanType, Show}]: Decoder[F, Cursor[S], Boolean] =
    Decoder.decodeB[F, S]
  ...
  given decodeBooleanS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Boolean] =
  ...
  given decodeFloatN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Float] =
  ...
  given decodeFloatS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Float] =
  ...
  given decodeDoubleN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Double] =
  ...
  given decodeDoubleS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Double] =
  ...
  given decodeByteN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Byte] =
  ...
  given decodeByteS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Byte] =
  ...
  given decodeShortN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Short] =
  ...
  given decodeShortS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Short] =
  ...
  given decodeIntN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Int] =
  ...
  given decodeIntS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Int] =
  ...
  given decodeLongN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], Long] =
  ...
  given decodeLongS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], Long] =
  ...
  given decodeBigIntN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], BigInt] =
  ...
  given decodeBigIntS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], BigInt] =
  ...
  given decodeBigDecimalN[F[_]: Applicative, S: {NumberType, Show}]: Decoder[F, Cursor[S], BigDecimal] =
  ...
  given decodeBigDecimalS[F[_]: Applicative, S: {StringType, Show}]: Decoder[F, Cursor[S], BigDecimal] =
